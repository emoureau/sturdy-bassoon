export default {
  root: ({ props }) => ({
    class: [
      ...
      // Shape
      'border-spacing-0 border-separate border border-1 border-surface-200',
    ],
  }),
  loadingoverlay: {
    class: [
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // Color
        (props.sortable === '' || props.sortable) && context.sorted ? 'text-primary-500 bg-primary-50' : 'bg-surface-0 text-surface-700',
