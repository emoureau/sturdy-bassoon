  ...
  content: ({ props, context }) => ({
    class: [
      ...
      //  Colors
      {
        ...
        'text-surface-500 dark:text-white/70 bg-primary-400/50 dark:bg-black/70': context.focused && !context.active,
        'text-surface-900 dark:text-surface-0/80 bg-surface-50 dark:bg-black/70': context.focused && context.active,
        'text-surface-900 dark:text-surface-0/80 bg-primary-400/50 dark:bg-black/70': !context.focused && context.active,
      },
